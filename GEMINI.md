...
- **Clowder AI runtime ports**: frontend 3001 and API 3002 are reserved by Clowder AI. Avoid using these ports for this project's dev servers.
- **Redis port 6099** is Clowder AI's production Redis. Never connect to it from external projects. Use 6398 for dev/test.
